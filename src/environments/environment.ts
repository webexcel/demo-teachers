...
export const environment = {
  ...
  pages : [
    ...
    { title: 'Flash Message',url: '/flash', icon: 'assets/imgs/speakers/flash.png',filter:"invert(77%) sepia(26%) saturate(7148%) hue-rotate(347deg) brightness(101%) contrast(98%)"},
  ...
  app_versionCode:"3",
  apiBaseUrl :'http://demo.schooltree.in/baseTeacher_dev.php/api/',
  version:"3",
